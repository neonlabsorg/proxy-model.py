...
from .neon_tx_send_simple_solana_call_strategy import SimpleNeonTxSolanaCallStrategy
...
class SimpleHolderNeonTxSolanaCallStrategy(SimpleNeonTxSolanaCallStrategy):
    name = EvmIxCodeName().get(EvmIxCode.TxExecFromAccountSolanaCall)
