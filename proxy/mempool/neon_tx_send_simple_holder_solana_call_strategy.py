...
from .neon_tx_send_simple_strategy_solana_call import SimpleNeonTxStrategySolanaCall, ALTSimpleNeonTxStrategySolanaCall
...
class NeonTxSendStrategyExecutor:
    _strategy_list = [
        SimpleNeonTxStrategySolanaCall, ALTSimpleNeonTxStrategySolanaCall,
